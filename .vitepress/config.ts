...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/rafbcampos/fluent-gen' },
      { icon: 'npm', link: 'https://www.npmjs.com/package/fluent-gen' }
    ],

    editLink: {
      pattern: 'https://github.com/rafbcampos/fluent-gen/edit/main/docs/:path',
